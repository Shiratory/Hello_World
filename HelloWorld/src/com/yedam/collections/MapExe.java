...
public class MapExe {
	public static void main(String[] args) {
		...
		books.put("B001", new Book("이것이자바다", "신용권", "한빛출", 20000, 0));
		books.put("B002", new Book("자바스크립트", "김자바", "한빛출", 25000, 0));
		books.put("B003", new Book("HTML,CSS", "김자바", "한빛출", 420000, 0));
